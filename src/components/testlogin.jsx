...
class Testlogin extends Component{
    ...
    render(){
      ...
      <div className="col-12">
      <center>
      <Link to={`/testloginsign?name=${this.state.testname}&id=${this.state.teacherid}&code=${this.state.testid}`} id="button2"   style={{marginLeft:"3%"}}>Login</Link>
      <Link to={`/testloginsign?name=${this.state.testname}&id=${this.state.teacherid}&code=${this.state.testid}`} id="button2"  style={{marginLeft:"2%"}}>SignUp</Link></center>
      </div>
      </div><br/>
      </div> 
      <br/><br/> 
